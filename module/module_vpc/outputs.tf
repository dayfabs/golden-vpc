...
output "tgwsubnet_subnets" {
  description = "List of IDs of tgwsubnet subnets"
  value       = aws_subnet.tgwsubnet[*].id
}

output "tgwsubnet_subnet_arns" {
  description = "List of ARNs of tgwsubnet subnets"
  value       = aws_subnet.tgwsubnet[*].arn
}

output "tgwsubnet_subnets_cidr_blocks" {
  description = "List of cidr_blocks of tgwsubnet subnets"
  value       = aws_subnet.tgwsubnet[*].cidr_block
}

output "tgwsubnet_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of tgwsubnet subnets in an IPv6 enabled VPC"
  value       = aws_subnet.tgwsubnet[*].ipv6_cidr_block
}
...
output "tgwsubnet_route_table_ids" {
  description = "List of IDs of tgwsubnet route tables"
  value       = aws_route_table.tgwsubnet[*].id
}
...
output "tgwsubnet_route_table_association_ids" {
  description = "List of IDs of the tgwsubnet route table association"
  value       = aws_route_table_association.tgwsubnet[*].id
}
...
output "tgwsubnet_network_acl_id" {
  description = "ID of the tgwsubnet network ACL"
  value       = try(aws_network_acl.tgwsubnet[0].id, "")
}

output "tgwsubnet_network_acl_arn" {
  description = "ARN of the tgwsubnet network ACL"
  value       = try(aws_network_acl.tgwsubnet[0].arn, "")
}
